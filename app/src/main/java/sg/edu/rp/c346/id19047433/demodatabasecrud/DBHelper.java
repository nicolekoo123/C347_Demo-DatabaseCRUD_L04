package sg.edu.rp.c346.id19047433.demodatabasecrud;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //DBHelper Retrieve all the notes
    ...
    //DbHelper get all notes with filter
    // the key work is set in the mainActivity when we call for this method
    ...
    //DBHelper delete data from the database
